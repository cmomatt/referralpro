import { pgTable, foreignKey, text, varchar, timestamp, unique, integer, jsonb, pgEnum } from "drizzle-orm/pg-core"
  import { sql } from "drizzle-orm"

export const referralStatus = pgEnum("referral_status", ['pending', 'contacted', 'accepted', 'rejected', 'completed'])
export const rewardStatus = pgEnum("reward_status", ['pending', 'paid', 'cancelled'])
export const rewardType = pgEnum("reward_type", ['cash', 'credit', 'gift', 'other'])
